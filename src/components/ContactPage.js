...
export default class ContactPage extends React.PureComponent {
    render() {
        return(<div className = "ContactPage" style = {{marginBottom: 20}}>
            ...
            You can also reach Professor Stantcheva via email at <a href = "mailto:sstantcheva@fas.harvard.edu">sstantcheva@fas.harvard.edu</a>
            <Subsection>Other research</Subsection>
            If you are interested in seeing other research projects from Professor Stantcheva's Social Economics Lab, you can visit the <a href = "http://socialeconomicslab.org/">Social Economics Lab Website</a>!
        </div>)
    }
}